...
const getLocationsByLatLon = async (req, res) => {
  ...
  var request = {
    method: "get",
    url: `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${req.params.lat},${req.params.long}&radius=15000&type=${req.params.type}&maxprice=2&key=AIzaSyAHjbhtGrQnSNHas2LvKI2-UOeu0bfT6C0`,
    headers: {},
  };
